...
plt.savefig('figs/Fig_3_c.eps', dpi=300, bbox_inches='tight')
plt.savefig('figs/Fig_3_c.svg', dpi=300, bbox_inches='tight') 
fig = plt.gcf()
...
plt.savefig('figs/Fig_3_d.eps', dpi=300, bbox_inches='tight')
plt.savefig('figs/Fig_3_d.svg', dpi=300, bbox_inches='tight')
plt.show()
...
fig=plt.gcf()
fig.set_size_inches(5, 4)
plt.savefig('figs/Fig_3_cdc.eps', dpi=300, bbox_inches='tight')
plt.savefig('figs/Fig_3_cdc.svg', dpi=300, bbox_inches='tight')
plt.show()
...
fig=plt.gcf()
fig.set_size_inches(5, 4)
plt.savefig('figs/Fig_3_cdd.eps', dpi=300, bbox_inches='tight')
plt.savefig('figs/Fig_3_cdd.svg', dpi=300, bbox_inches='tight')
plt.show()
